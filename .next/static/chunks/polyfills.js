!(function () {
  ...
  var Ht =
      ...
      function (t, e) {
        var r
        return (
          null !== t ? ((Gt.prototype = R(t)), (r = new Gt()), (Gt.prototype = null), (r[Kt] = t)) : (r = Vt()),
          void 0 === e ? r : zt(r, e)
        )
      },
    Xt = Dt('unscopables'),
          ...
          u = function (t, e, r) {
            ...
            return (
              c
                ? (c.value = r)
                : ((u.last = c =
                    { index: (o = zr(e, !0)), key: e, value: r, previous: (n = u.last), next: void 0, removed: !1 }),
                  u.first || (u.first = c),
                  n && (n.next = c),
                  i ? u.size++ : t.size++,
                  'F' !== o && (u.index[o] = c)),
  ...
  var pu =
    ...
    vu = function (t) {
      return function (e, r, n) {
        ...
        return c <= u || '' == s
          ? a
          : ((i = pu.call(s, du((o = c - u) / s.length))).length > o && (i = i.slice(0, o)), t ? a + i : i + a)
      }
    },
        ...
        switch (((i = o[f]), c)) {
          ...
          case nc:
            if (i && (Is.test(i) || '+' == i || '-' == i || '.' == i)) l += i.toLowerCase()
              ...
              if (
                r &&
                (Xs(t) != b(Hs, l) || ('file' == l && (Ys(t) || null !== t.port)) || ('file' == t.scheme && !t.host))
              )
                return
