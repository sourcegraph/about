...
1. **Campaigns are polished and adopted by customers**
   1. Document campaigns and write a blog post about it. => Documentation has been greatly improved (see [documentation here](https://docs.sourcegraph.com/user/campaigns). No blog post.
