...
1. **Increase adoption of search at customers**
   ...
   1. At least four customers are running structural searches and metrics to validate this KR are tracked in [pings](https://docs.sourcegraph.com/admin/pings). => Evidence of usage at existing and prospective customers.
