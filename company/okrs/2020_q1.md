...
1. **Transparent and scalable code-host permissions syncing**
   ...
   1. Admins can force the refresh of permissions of individual users. => Reached agreement on UI/UX design, actual work is undertaking.
   ...
   1. Admins can see when a repository or user's permissions were last updated and when they are scheduled to be updated again. => Reached agreement on UI/UX design, actual work is undertaking.
