...
1. **Build a fair and consistent hiring process that supports candidates, interviewers, and hiring managers.**
1. **Create a customized onboarding process for each role/team that will make new teammates feel they belong while also ramping up as efficiently as possible.**
1. **Design and implement a teammate experience that makes teammates proud to work at Sourcegraph and want to share that experience with others.**
