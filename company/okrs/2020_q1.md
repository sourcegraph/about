...
1. **Code intelligence: Make it easy for customers to set up LSIF**
   1. Code intelligence KR: Create a multi-language indexer that auto-detects project structure
   1. Code intelligence KR: Ensure that the GitHub Action is reusable without modification
   1. Code intelligence KR: Make an automation campaign that adds a GitHub Action to all repositories
...
1. **Code intelligence: Make it clear where code intel results are coming from**
   1. Code intelligence KR: UI indicator
