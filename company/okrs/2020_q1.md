...
1. **Campaigns are polished and adopted by customers**
   1. Document campaigns and write a blog post about it. => Documentation has been greatly improved. No announcement blog post yet, but created multiple demo videos and demo campaigns.
