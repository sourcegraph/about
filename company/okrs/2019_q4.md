...
1. **CEO: Standard developer platform**
   ...
   1. **VP Eng: Deliver the product roadmap.**
      ...
      1. **Web: Make the power of search accessible to more users.**
         1. Web KR: Eliminate errors caused by malformed search queries (e.g. literal search, autocomplete).
         1. Web KR: Increase usage of filters (e.g. filter UI).
      1. **Web: Data driven decisions for search improvements.**
         ...
         1. Web KR: Measure the number of searches that result in an error.
