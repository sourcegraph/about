...
Each hiring manager has an [assigned recruiter](https://about.sourcegraph.com/handbook/talent) for their hiring needs. If you are unsure which Recruiter you should partner with, please Slack @hiring to inquire. 
...
- [Sourcegraph interview process](https://about.sourcegraph.com/handbook/talent/interview_process).
- [Types of interviews & interview questions](https://about.sourcegraph.com/handbook/talent/types_of_interviews).
...
- Once the Hiring Manager completes the above steps, the Recruiter takes the below actions:
    ...
    - Recruiter posts the job to our [Careers page](https://boards.greenhouse.io/sourcegraph91) and LinkedIn. If you would like it posted in other locations, please ask your Recruiter or send a Slack message to @hiring.  You can see a list of other job boards we are considering [here](https://about.sourcegraph.com/handbook/talent/hiring/job_boards).
...
- Recruiting Coordinator schedules additional interviews for candidates.
    - [Interview process for each department](https://about.sourcegraph.com/handbook/talent/interview_process)
...
- Recruiter confirms level and compensation.
    - [Compensation philosophy](https://about.sourcegraph.com/handbook/people-ops/compensation#components-of-compensation)
...
You can see a list of all recruiting tools [here](https://about.sourcegraph.com/handbook/talent/hiring#recruiting-tools).  If you need a tool not listed, please Slack #hiring to request it.
...
To schedule an interview with a candidate, please reach work with your recruiter or Slack @hiring.  You can see a list of Recruiters [here](https://about.sourcegraph.com/handbook/talent).
