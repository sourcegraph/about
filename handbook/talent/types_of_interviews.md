...
- Duration: 30-minutes (5-minute intro/agenda, 15-minute interview, 10-minutes for candidate's questions).
...
- Example questions: 
  ...
  -  What you are looking for in your next role?  What are you career goals?
  -  How much exposure have you had working with teammates across timezones? How did you stay connected and up-to-date?
...
- Duration: 60-minutes (5-minute intro/agenda, 45-minute resume deep dive, 10-minutes for candidate's questions)
...
- Duration: 30-minutes.
- Details: this interview is focused entirely on [our values](https://about.sourcegraph.com/handbook/company/values) and how a candidate's views and experiences align with them. Our values are key to our success as individuals and as a company.
- Example questions: 
...
# Department specific interviews / assignments 
...
- SDR presentation
  -  Interviewer(s): _____________
  -  Duration: _____________
  -  Details: For the presentation, you will walk the panel through a brief introduction of yourself, present a pipeline generation plan, and share a 30/60/90 day plan. Use this template for your presentation and please check out the speaker notes -- they have a lot of detail on what we are looking for!
...
- Recruiter assignment 
  -  Interviewer(s): NA - this is a take home assignment.
  -  Duration: we expect this to take no more than 1 hour.
  -  Details: we want to ensure we understand your approach to proactively reaching out to and engaging with passive talent.  Instructions: **Step 1.** You are the newly assigned Recruiter for the [pick a job on our website] role. As a first step, you'll want to have an intake meeting with the Hiring Manager.  What questions do you plan to ask to gain a full understanding of the role? **Step 2.** We have posted the job and have received zero applicants, so we need to go out and recruit the right person.  Please identify 5 target candidates and explain 1) how you found them (what search string(s) did you use) and 2) why are you are targeting them specifically? **Step 3.** As we know, rarely do we hear back from a candidate after our 1st message or call.  Pick one of the above profiles and please describe your outreach "campaign."  What steps will you take to engage with this candidate?  Please 1) include example inmails, emails, voicemails etc, and 2) please explain your approach and why you chose to craft your outreach campaign in this way. Your ultimate goal is to secure a call with the candidate.
