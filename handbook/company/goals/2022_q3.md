...
- Launch a new version of our feedback review cycles, centered around the impact that teammates have on a company-wide level, at a team level, and most importantly, on a personal level within Sourcegraph. These Impact review cycles will encompass an asynchronous review cycle based on each teammates start date, review questions centered around our values, and new developmental resources for teammates to track the progress of their growth over 6-month periods.
