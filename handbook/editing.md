...
**Is this your first time using GitHub? Do you not feel confortable editing the handbook?** Visit [this handbook page](first-steps-to-edit-handbook.md) to read about basic concepts and steps.
