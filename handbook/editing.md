...
**Why do we do this?**
We can use URLs to link pages, but they are absolute. If the absolute URL changes, it is more difficult to update the information. Relative paths are easier to update and least probable to be an issue. 
