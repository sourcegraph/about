...
1. We schedule a live, 90-minute pair-programming exercise with a Sourcegraph engineer. We give you a data file, and ask you to write a command-line application, in the language of your choice, to parse the file and output information.
