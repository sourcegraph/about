...
> **Note:** Looking for _how to develop Sourcegraph monitoring?_ See the [monitoring developer guide](../../observability/monitoring.md).
...
To better understand our goals with Sourcegraph's monitoring stack, please read [monitoring pillars: long-term vision](../../observability/monitoring_pillars.md#long-term-vision).
...
This allows us to assert constraints and principles that we want to hold ourselves to, as described in [our monitoring pillars](../../observability/monitoring_pillars.md).

To learn more about adding monitoring using the generator, see: [adding monitoring](../../observability/monitoring.md#adding-monitoring)
...
1. We do not want customers, or ourselves, to introduce dashboards or modifications through the Grafana web UI (see [monitoring pillars: long-term-vision](../../observability/monitoring_pillars.md#long-term-vision))
...
*Rationale for notifiers in site configuration*: Due to the limitations of [admin reverse-proxies](#admin-reverse-proxy), alerts cannot be configured without port-forwarding or custom ConfigMaps, something we [want to avoid](../../observability/monitoring_pillars.md#long-term-vision).
...
*Rationale for silencing in site configuration*: Similar to the [Grafana admin reverse-proxy](#admin-reverse-proxy), silencing using the Alertmanager UI would require port-forwarding, something we [want to avoid](../../observability/monitoring_pillars.md#long-term-vision).
