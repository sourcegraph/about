...
The distribution team runs a backlog grooming session every two weeks to ensure that backlog is correctly priorotized for the upcoming sprint. 
...
To add an issue, tag it team/distribution to notify the distribution team.
