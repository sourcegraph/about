...
- If you need access to Percy for visual testing, create an account by going to https://percy.io/invite-login and then ask on `#dev-chat` for an invitation to our Percy org. **Do not create an account on Browserstack as this is not supported for our organization.**
