...
* Save a copy in the [NDAs](https://drive.google.com/drive/folders/1kwsephGh0quiOIgvLBE_XU3DEfe97Z78) folder in the following naming format: 
...
1. Third party name
1. Nature of business opportunity (e.g., prospective customer, vendor, partner)
...
* Save a copy in the specific [Customer](https://drive.google.com/drive/folders/1ePvVWcZYdd1_3ZlCP5A0lvMbBhBCVfSm) folder in the following naming format: 2021-01-01-Customer Name-Agreement Name (use Effective Date or if unavailable then date of last signature)
* Upload fully signed contracts to the Salesforce Account

What to include in your requests?

1. Customer Name
1. What are you selling (on prem, hosted, air-gapped (“offline”), etc.)
1. Approx. ACV
1. Any other context or anything of note
1. Any urgent deadlines
...
* Save a copy in the [Suppliers](https://drive.google.com/drive/folders/1hO7wFuvix3QcIDgM6OLNyjfElOUv-s0k) folder in the following naming format: 
2021-01-01-Supplier Name-Agreement Name (use Effective Date or if unavailable then date of last signature)

What to include in your requests?

1. Vendor Name
1. Purpose of contract (1-2 sentences)
...
* Save a copy of the fully signed contract in the [Partners](https://drive.google.com/drive/folders/1Cl3B560wT85Zj4crlvZ7ngRoHCTqdn6q) folder in the following format: 2021-01-01-Partner Name-Agreement Name (use Effective Date or if unavailable then date of last signature)
...
1. Partner Name
1. Purpose of contract (1-2 sentences)
1. Data: Confirm whether the partner will access customer data or other sensitive data
