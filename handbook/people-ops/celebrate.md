...
To add the BambooHR "Birthdays" calendar to your Google Calendar, please use this link (https://sourcegraph.bamboohr.com/feeds/feed.php?id=535bc86f7d5ecda6e76e4e3a05291665) and go to [**Google Calendar**](https://calendar.google.com), click gear icon (**Settings**) in upper righthand corner, click **Add calendar** on lefthand side, click **From URL**, paste link in **URL of calendar** box, click **Add calendar**.
