...
- Metrics
	...
	- Note: this spreadsheet is updated manually, so it will not be updated in real-time. The BizOps team is committed to updating the sheet within 3 business days (but in most circumstances much sooner) of the closing of a new or renewal deal, or the end of the month for expansions and churns. 
