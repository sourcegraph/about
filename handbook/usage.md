...
Sourcegraph is an [open product, an open company, and open source](../company/values.md#open-and-transparent). Our company principles, strategies, and processes are all publicly documented.
