...
|repository   |repo   | We try to [avoid abbreviations, acryonyms, latinisms, and jargon when possible](../style_and_mechanics.md#abbreviations-acronyms-latinisms-jargon). We habitually shorten words for concepts we work with every day until they become obvious to us, like repo, org, j2d, find-refs, PR, revs... but they aren't obvious to outsiders, which can be confusing and result in a steeper learning curve for new users. In this spirit, we prefer "repository" and "respositories". |
|**S**   |   |   |
