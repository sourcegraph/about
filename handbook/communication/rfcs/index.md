...
- Metadata about the state of the RFC. Including but not limited to:
  ...
  - **Requested reviewers:** The list of people that the RFC author is requesting a review from and a requested deadline for those reviews (e.g. "Requested reviewers: Alice and Bob can you please review by 10am PST on 2020-10-21"). The author is responsible for ensuring that the reviewers aware of the review request (e.g. by sending them a Slack message or tagging them in a comment on the Google Doc).
  - **Suggested reviewers:** As we grow as a company, it's not always obvious whose feedback may be valuable. Anyone reading an RFC should feel empowered to suggest reviewers to the author. The author is free to decide whether or not to accept the suggested reviewers. If accepted, they should be moved to the "requested reviewers" list.
