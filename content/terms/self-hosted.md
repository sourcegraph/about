...
See the [changes](https://sourcegraph.com/search?q=context:global+repo:%5Egithub%5C.com/sourcegraph/about%24+file:%5Edocs/terms-self-hosted%5C.md+type:diff&patternType=literal) since the [previous version](/terms/archives/self-hosted/2022-09-09/) or visit our [archives](https://github.com/sourcegraph/about/tree/main/content/terms/archives).
...
<table>
  ...
  <tr>
   <td>1. <a href="https://about.sourcegraph.com/terms-self-hosted/#1-definitions">Definitions</a> 
   </td>
   <td>Definitions of specific terms used on this page
   </td>
  </tr>
  <tr>
   <td>2. <a href="https://about.sourcegraph.com/terms-self-hosted/#2-account-terms">Account terms</a>
   </td>
   <td>Your responsibilities to use Sourcegraph
   </td>
  </tr>
  <tr>
   <td>3. <a href="https://about.sourcegraph.com/terms-self-hosted/#3-acceptable-use">Acceptable use</a>
   </td>
   <td>Acceptable use of Sourcegraph
   </td>
  </tr>
  <tr>
   <td>4. <a href="https://about.sourcegraph.com/terms-self-hosted/#4-usage-data">Usage data</a>
   </td>
   <td>Aggregate and high-level data we collect from self-hosted Sourcegraph instances
   </td>
  </tr>
  <tr>
   <td>5. <a href="https://about.sourcegraph.com/terms-self-hosted/#5-data-protection">Data protection</a>
   </td>
   <td>Our policies for protecting your data
   </td>
  </tr>
  <tr>
   <td>6. <a href="https://about.sourcegraph.com/terms-self-hosted/#6-confidentiality">Confidentiality</a>
   </td>
   <td>Our mutual responsibilities to protect confidential data
   </td>
  </tr>
  <tr>
   <td>7. <a href="https://about.sourcegraph.com/terms-self-hosted/#7-term-termination">Term; termination</a>
   </td>
   <td>When and how your account can be terminated
   </td>
  </tr>
  <tr>
   <td>8. <a href="https://about.sourcegraph.com/terms-self-hosted/#8-fees">Fees</a>
   </td>
   <td>Rules for payment for paid and Enterprise features
   </td>
  </tr>
  <tr>
   <td>9. <a href="self-hosted.md#9-maintenance-warranties-disclaimer">Maintenance; warranties; disclaimer</a> 
   </td>
   <td>Our warranties about Sourcegraph
   </td>
  </tr>
  <tr>
   <td>10. <a href="https://about.sourcegraph.com/terms-self-hosted/#10-limitation-of-liability">Limitation of liability</a>
   </td>
   <td>Our liabilities are limited
   </td>
  </tr>
  <tr>
   <td>11. <a href="https://about.sourcegraph.com/terms-self-hosted/#11-indemnification">Indemnification</a>
   </td>
   <td>The parties’ respective indemnification obligations
   </td>
  </tr>
  <tr>
   <td>12. <a href="https://about.sourcegraph.com/terms-self-hosted/#12-export-controls">Export controls</a>
   </td>
   <td>Usage restrictions in embargoed locations
   </td>
  </tr>
  <tr>
   <td>13. <a href="https://about.sourcegraph.com/terms-self-hosted/#13-governing-law-arbitration-and-class-actionjury-trial-waiver">Governing law; arbitration; and class action/jury trial waiver</a>
   </td>
   <td>Where and how disputes would be handled
   </td>
  </tr>
  <tr>
   <td>14. <a href="/self-hosted.md#14-Miscellaneous">Miscellaneous</a>
   </td>
...
<span className="tw-text-gray-400"><i>**Short version**: You – or the organization you work for – is responsible for your instance and its security, as well as everything posted on it. You must be 18 or over to use our services.</i></span>
...
<span className="tw-text-gray-400"><i>**Short version**: We have the right to collect Usage Data from self-hosted Sourcegraph instances, as described in our [Privacy Policy](/terms/privacy) and specifically listed in our [product documentation](https://docs.sourcegraph.com/admin/pings).</i></span>
...
<span className="tw-text-gray-400"><i>**Short version**: We will each protect the other party’s confidential information.</i></span>
...
<span className="tw-text-gray-400"><i>**Short version**: You may shut down your instance any time. We may terminate the agreement at any time, at which point your right to use the software will immediately expire.</i></span>
...
<span className="tw-text-gray-400"><i>**Short version**: You’re responsible for any fees associated with your use of Sourcegraph. Your subscription will automatically renew, unless an Order Form states otherwise.</i></span>

8.1 **Pricing**. You are responsible for paying any applicable fees as set forth on our [Pricing and Payment Terms](https://about.sourcegraph.com/pricing) or in an Order Form and applicable taxes associated with the Software in full in a timely manner with a valid payment method. Unless otherwise stated in an Order Form, you will pay all invoices within thirty (30) days of receipt. You agree that we may charge for any such fees owed. You are required to keep your billing information current.
...
<span className="tw-text-gray-400"><i>**Short version**: Other than the warranties explicitly set forth in this section, Sourcegraph is provided “as is” with no guarantees of any kind (unless applicable law provides you additional mandatory rights). Please read this section carefully.</i></span>
...
<span className="tw-text-gray-400"><i>**Short version**: Each party's liability is limited to direct damages wherever possible, and to no more than $100 or the amount you paid us to access the software. Please read this section carefully.</i></span>
...
<span className="tw-text-gray-400"><i>**Short version**: Each of us agrees to defend the other against third-party lawsuits that result from matters under our respective responsibility.</i></span>
...
<span className="tw-text-gray-400"><i>**Short version**: Don’t use our site or software if you’re located in an embargoed country.</i></span>
...
<span className="tw-text-gray-400"><i>**Short version**: We’re based in California, so the agreement is governed by California law, and all disputes must be brought there. If you have a claim against us, you’ll work with us to arbitrate it on an individual basis instead of via class action or jury trial.</i></span>
