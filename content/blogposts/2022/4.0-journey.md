...
Sourcegraph today is growing rapidly in both adoption and revenue. We remain committed to our north star vision of democratizing code understanding.

In the nearer term, we're focusing on scale.

* Scale - supporting ever larger codebases
* Continue to collaborate with open-source communities. CTA here for getting in touch
  * A truly open future for code

> NEXT: 2 hours remaining
> 1. Create gifs
> 2. Write conclusion
> 3. Add some old images
>
> Extra
