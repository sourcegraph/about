...
<a href="https://docs.sourcegraph.com/code_search/explanations/features" className="not-italic flex items-center mb-sm">Docs<OpenInNewIcon className="ml-xxs" size={18} /></a>
...
<a href="https://docs.sourcegraph.com/code_search/how-to/search_contexts" className="not-italic flex items-center mb-sm">Docs<OpenInNewIcon className="ml-xxs" size={18} /></a>
...
<a href="https://docs.sourcegraph.com/admin/config/webhooks" className="not-italic flex items-center mb-sm">Docs<OpenInNewIcon className="ml-xxs" size={18} /></a>
...
<a href="https://docs.sourcegraph.com/admin/observability/outbound-request-log" className="not-italic flex items-center mb-sm">Docs<OpenInNewIcon className="ml-xxs" size={18} /></a>
