                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-12 my-8 text-center">
                                ...
                                <p>All remote - work from anywhere.</p>
                                <div>
                                    <Link className="btn btn-primary my-2" to="#" title="Talent grows here">
                                        Talent grows here
                                    </Link>
                            ...
                            <div className="col-lg-12 my-8 text-center">
                                ...
                                <p>A transparent and people-first culture.</p>
                                <div>
                                    <Link className="btn btn-primary my-2" to="#" title="Talent grows here">
                                        Talent grows here
                                    </Link>
                            ...
                            <div className="col-lg-12 my-8 text-center">
                                ...
                                <p>Unlimited time off with a 30-day PTO requirement.</p>
                                <div>
                                    <Link className="btn btn-primary my-2" to="#" title="Talent grows here">
                                        Talent grows here
                                    </Link>
                            ...
                            <div className="col-lg-12 my-8 text-center">
                                ...
                                <p>Competitive financial benefits and stock options.</p>
                                <div>
                                    <Link className="btn btn-primary my-2" to="#" title="Talent grows here">
                                        Talent grows here
                                    </Link>
                            ...
                            <div className="col-lg-12 my-8 text-center">
                                ...
                                <h4 className="display-3">
                                    Because you know real growth happens when we take care of each other;
                                </h4>
                                <p>Financial compensation for wellness, family planning, and continued education.</p>
                                <div>
                                    <Link className="btn btn-primary my-2" to="#" title="Talent grows here">
                                        Talent grows here
                                    </Link>
                            ...
                            <div className="col-lg-12 my-8 text-center">
                                <img src="../test-seed-4.png" className="seeds mb-4" />
                                <h4 className="display-3">
                                    our roots grow deeper, leaves become stronger,  and wildflowers bloom.
                                </h4>
                                <p>Explore our Talent Garden</p>
                                <div>
                                    <Link className="btn btn-primary my-2" to="#" title="Talent grows here">
                                        Talent grows here
                                    </Link>
                        ...
                        <div className="col-lg-5 ml-6">
                            <div className="scrollable-container">
                                <div className="mb-6">
                                    ...
                                    <a className="job-link mt-4" href="">
                                ...
                                <div className="mb-6">
                                    ...
                                    <a className="job-link mt-4" href="">
                                        Full Stack Engineer - Extensibility
                                    </a>
                                </div>
                                <div className="mb-6">
                                ...
                                <div className="mb-6">
                                    ...
                                    <a className="job-link mt-4" href="">
                                        Senior Advisor, Value Engineering
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-lg-12">
                                <div id="animated-container">
                                    <div id="animated-text">
                                        <h2
                                            className="carouselItem d-inline-block mx-3 font-size-large"
                                            onClick={() => openFlyout('AllRemote')}
                                        >
                                        ...
                                        <h2
                                            className="carouselItem d-inline-block mx-3 font-size-large"
                                            onClick={() => openFlyout('FlexiblePTO')}
                                        >
                                        ...
                                        <h2
                                            className="carouselItem d-inline-block mx-3 font-size-large"
                                            onClick={() => openFlyout('FamilyPlanningSupport')}
                                        >
                                            <img
                                                className="icon mx-3 mb-3"
                                                src="../icons/FamilyPlanningSupport_white.png"
                                            />
                                            Family Planning Support
                                        </h2>
                                        <h2
                                            className="carouselItem d-inline-block mx-3 font-size-large"
                                            onClick={() => openFlyout('ProfessionalDevelopment')}
                                        >
                                ...
                                <div className="flyoutContainer">
                                    <div id="AllRemote" className="flyout">
                                        <div className="flyoutHeader p-2">
                                            ...
                                            <span
                                                className="float-right mx-3 closeIcon"
                                                onClick={() => closeFlyout('AllRemote')}
                                            >
                                                x
                                            </span>
                                        </div>
                                        <div className="px-5 py-2 flyoutBody">
                                            <p>
                                                We want our teammates to be happy, healthy, and productive. In order to
                                                best support that, we provide the following perks and benefits.
                                            </p>
                                        </div>
                                    </div>
                                    <div id="FlexiblePTO" className="flyout">
                                        <div className="flyoutHeader p-2">
                                            ...
                                            <span
                                                className="float-right mx-3 closeIcon"
                                                onClick={() => closeFlyout('FlexiblePTO')}
                                            >
                                                x
                                            </span>
                                        </div>
                                    ...
                                    <div id="Wellness" className="flyout">
                                        ...
                                        <div className="px-5 py-2 flyoutBody">
                                            <p>
                                                A healthy mind and body is imperative to doing your best work and living
                                                a healthy life.
                                            </p>
                                            <p>
                                                We offer an $100 monthly wellness stipend that can be used at your
                                                discretion.
                                            </p>
                                        </div>
                                    </div>
                                    <div id="FamilyPlanningSupport" className="flyout">
                                        <div className="flyoutHeader p-2">
                                            ...
                                            <span
                                                className="float-right mx-3 closeIcon"
                                                onClick={() => closeFlyout('FamilyPlanningSupport')}
                                            >
                                                x
                                            </span>
                                        </div>
                                    ...
                                    <div id="ProfessionalDevelopment" className="flyout">
                                        <div className="flyoutHeader p-2">
                                            ...
                                            <span
                                                className="float-right mx-3 closeIcon"
                                                onClick={() => closeFlyout('ProfessionalDevelopment')}
                                            >
                                                x
                                            </span>
                                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <p className="font-size-large">
                                    We want our teammates to be happy, healthy, and productive. In order to best support
                                    that, this is what we provide.
                                </p>
                            </div>
                        </div>
                    </ContentSection>
                ...
                <ContentSection className="values mt-8 mb-6">
                    ...
                    <div className="row mt-2">
                        ...
                        <div className="col-lg-4">
                            ...
                            <p className="mt-4">
                                You work collaboratively with your peers, cross-functional teammates, and leadership to
                    ...
                    <div className="row mt-2">
                        ...
                        <div className="col-lg-4 mt-4">
                            ...
                            <p className="mt-4">
                                ...
                                product. You deliver regardless of the circumstances.
                            </p>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-lg-4 mt-4">
                            ...
                            <p className="mt-4">
                                You make people from all groups and backgrounds feel comfortable belonging to our team
                                and community.
                            </p>
                        </div>
                        <div className="col-lg-4 mt-4">
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <p>
                                    ...
                                    incididunt ut labore et dolore magna aliqua. Interdum varius sit amet mattis
                ...
                <ContentSection className="mt-8">
                    <div className="row">
                        <div className="col-lg-6">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                incididunt ut labore et dolore magna aliqua. Interdum varius sit amet mattis vulputate
