...
export default ((props: any) => (
    <Layout
        ...
        meta={{
            ...
            description: 'FactSet provides financial data and software solutions for over 100,000 investment professionals around the world.',
            ...
            <ContentSection color="white" className="col-md-6">
                <div className="container">
                    ...
                    <p>
                        ...
                        monolithic code repository in Perforce to microservices in GitHub. Part of the reason for migrating 
                        involved recruiting and onboarding—new developers often hadn’t even heard of Perforce and didn’t know 
                        how to use it. In addition, moving to a git-based system had technical benefits for FactSet, including 
                        increased code stability, fewer failed deployments and broken builds, and a more agile, incremental 
                        approach to software engineering.
                    </p>

                    <p>
                        The developer services team spearheaded the transition to GitHub and met weekly with developers to 
                        provide updates and address issues. Soon after migrating the first 20+ repositories, the team 
                        responsible for FactSet’s market data platform, which ingests a huge amount of data from different 
                        stock exchanges, brought a major problem to their attention: the team could no longer search the code.
                    </p>

                    <p>
                        The market data application is structured with approximately 100 different children classes of the same 
                        templates, repeated over and over. That structure is part of why the team relies so heavily on code search, 
                        just to see exactly which instance of a class is being called and what it is doing.
                    </p>

                    <p>
                        “Mid-migration, it became very clear that we had to find an efficient way to search code. Thankfully, 
                        we discovered Sourcegraph,” said Derrick Faunce, Associate Director of Developer Services at FactSet.
                    </p>
                    ...
                    <p>
                        ...
                        real-time news and quotes engine. But after receiving positive feedback, the team gave another 200+ 
                        developers access to Sourcegraph. A month later, they surveyed Sourcegraph users to see how engaged 
                        they were with the product.
                    </p>

                    <p>
                        “The responses were heavily biased towards, ‘I’m using this every day, or even multiple times in any 
                    ...
                    <p>
                        ...
                        consistency as well as eliminating duplicative efforts.
                    </p>
                    ...
                    <p>
                        “Being able to have code exploration is a base requirement of efficient development,” said Joseph Majesky, 
                        Software Engineer at FactSet.” Majesky was one of the developers who discovered Sourcegraph during the 
