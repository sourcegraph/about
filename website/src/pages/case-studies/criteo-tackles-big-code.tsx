            ...
            <ContentSection color="white" className="col-md-6 pb-5">
                <div className="container">
                    ...
                    <InContentBlockquote
                        ...
                        author="François Jehl"
                    />
                    <p>Sourcegraph serves as Criteo’s one-stop shop for searching across all of its codebases, making its employees' lives that much easier. Criteo relies on many different ecosystems for different teams, and Sourcegraph now provides the ability to cross boundaries of different codebases and different languages authored by different people with different tools.</p>
                    <p>Developers start with a query, then use the recommended filters to narrow their search until they locate the piece of code that is of interest. “Sometimes they don’t even know what they’re looking for—perhaps just patterns that need to be deprecated. With our previous tools, the results were not good,” said François Jehl.</p>
                    <h2 className="pt-5 pb-1">Survey says Sourcegraph is the ultimate time-saver</h2>
                    <p>Criteo conducted an internal survey with Sourcegraph early adopters to determine how Sourcegraph has impacted its developers’ workflows. The survey found that 83 percent of those developers used Sourcegraph every single day, and nearly two-thirds used it several times per day.</p>
                    <p>55 percent of respondents said Sourcegraph saved them a few dozen minutes per day, while 18 percent stated they saved over an hour per day.</p>
                    <InContentBlockquote
                        ...
                        author="François Jehl"
                    />
                    <p>As codebases grow larger, Sourcegraph will continue to serve as the backbone to help developers at Criteo quickly search through code to understand what’s happening within its ecosystem.</p>
                    <InContentBlockquote
