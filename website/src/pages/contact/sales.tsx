            ...
            <section className="d-flex flex-column flex-lg-row sales">
                <div className="form-area">
                    <div>
                        ...
                        <p>
                            Let us know which <Link to="/pricing">paid product</Link> you're interested in and for how
                            many users. Our team is happy to answer any questions. Fill out the form and we’ll be in
                    ...
                    <div className="d-flex flex-column panel">
                        ...
                        <div className="panel__help">
                            ...
                            <p>
                                ...
                                <a href="mailto:support@sourcegraph.com">support@sourcegraph.com</a>, or file issues on{' '}
                                our <a href="https://github.com/sourcegraph/issues/issues">public issue tracker</a>.
                            </p>
                        </div>
                    </div>
                </div>
