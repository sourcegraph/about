                            ...
                            <div className="container v-prop__container">
                                <div className="row py-4 d-flex flex-row-reverse">
                                    <div className="col-md-6">
                                        <img
                                            width="100%"
                                            src="/products/code-intelligence/GitHubCodeIntelligence.png"
                                        />
                                    </div>
                                    <div className="col-md-6">
                                        ...
                                        <p className="mb-3">
                                            By default, the extension will add code intelligence and code search to
                                            public repositories on GitHub.com.
                                        </p>
                                        <p className="mb-3">
                                            The extension can be configured to work on private code by connecting it to
                                            a Sourcegraph instance that has code intelligence.
                                        </p>
                                ...
                                <div className="row py-4">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <p>
                                            Code intelligence makes browsing code files and diffs easier on your code
                                            host with IDE-like hovers, go-to-definition, and find-references on your
                                            code, powered by language servers based on the open-source Language Server
                                            Protocol.
                                        </p>
                                        <BrowserInstallButtons />
                                    </div>
