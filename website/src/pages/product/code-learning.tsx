...
export default ((props: any) => (
    <Layout location={props.location}>
        ...
        <ContentPage title="Learn code faster" description={description} className="pb-2">
            <PageSectionLinks
                sections={[
            ...
            <ContentSection color="white" className="pb-2">
                ...
                <p className="text-center mb-5">
                    ...
                    code and public codebases with contextual code intelligence to accelerate understanding code when
                    onboarding new developers and reviewing unfamiliar code.
                </p>
                <div className="row">
            ...
            <ContentSection color="white" className="pb-2">
                <div className="row justify-content-center py-4">
                    <div className="col-lg-10 text-center">
                        <img src="/external-logos/yelp.svg" />
                        <blockquote className="blockquote case-studies__quote case-studies__quote--in-content">
                            <p>
