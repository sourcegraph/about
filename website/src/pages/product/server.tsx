...
import { ChevronRightIcon, CityIcon, MagnifyIcon, OpenInAppIcon, PowerPlugIcon, WebIcon } from 'mdi-react'
import * as React from 'react'
import { ServerVersionNumber } from '../../components/ServerVersionNumber'
import { eventLogger } from '../../EventLogger'

export default class Server extends React.Component<any, any> {
                            ...
                            <div className="col product__server__col-right">
                                <div className="product__server__jumbo-col-text">
                                    ...
                                    <p className="mb-4">
                                        ...
                                        helps developers find, review, understand, and debug code. Use it with any Git
                                        code host for teams from 1 to 10,000.&nbsp; Get started quickly:{' '}
                                        <a
                                            href="/docs"
                                            className="hero-link"
                            ...
                            <div className="col product__server__feature-block-extra-row-col">
                                <div className="alert alert-secondary p-4 mb-0 d-flex" role="alert">
                                    ...
                                    <span>
                                        ...
                                        code search tool to be critical. Developers use it on average for 5.3 sessions
                                        each day, primarily to (in order of frequency): find example code, explore/read
                                        code, debug issues, and determine the impact of changes.
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row product__server__feature-block-extra-row">
                            <div className="col product__server__feature-block-extra-row-col">
                                <p>
                                    ...
                                    Server Protocol, find the latest support for your favorite language, and get
                                    involved.
                                    <br />
                                </p>
                            </div>
                    ...
                    <div className="container v-prop__container">
                        <div className="row" id="integrations">
                            <div className="col-md-12" style={{ textAlign: 'center' }}>
                                ...
                                <h1>Integrations</h1>
                                <p>
                                    Connect your Sourcegraph instance with your existing tools. Get code intelligence
                                    while browsing code on the web, and code search from your editor.
                                </p>
                                <div>
                                ...
                                <div>
                                    <div className="row">
                                        <div className="col product__server__deploy-text">
                                            ...
                                            <p>
                                                As you grow to hundreds or thousands of users and repositories, upgrade
