...
const Server: React.FunctionComponent<any> = props => (
                    ...
                    <div className="row">
                        <div className="col product__server__col-right">
                            <div className="product__server__jumbo-col-text">
                                <h3>Sourcegraph</h3>
                                <h1>Code search and navigation</h1>
                                <p className="mb-4">
                                    Sourcegraph is a free, self-hosted code search and intelligence server that helps
                                    developers find, review, understand, and debug code. Use it with any Git code host
                                    for teams from 1 to 10,000.&nbsp; Get started quickly:{' '}
                        ...
                        <div className="col">
                            <div className="product__server__jumbo-col">
                                <div className="product__server__jumbo-col-instructions">
                                    <p className="mb-0">
                                        <strong>Quickstart</strong>: Run this command, wait for the server to be ready,
                                        then visit&nbsp;
                                ...
                                <div className="product__server__jumbo-col-command">
                                    <p className="mb-0 code pre-wrap" style={{ fontSize: '0.85rem' }}>
                                        ...
                                        <span className="virtual-br" /> -v ~/.sourcegraph/config:/etc/sourcegraph
                                        <span className="virtual-br" /> -v ~/.sourcegraph/data:/var/opt/sourcegraph
                                        <span className="virtual-br" /> -v /var/run/docker.sock:/var/run/docker.sock
