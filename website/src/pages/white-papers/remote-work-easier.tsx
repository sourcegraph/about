...
import * as codelinksharing from '../../../static/white-papers/remotework-codelinksharing.png'
import * as codereview from '../../../static/white-papers/remotework-codereview.png'
import * as commithistory from '../../../static/white-papers/remotework-commithistory.png'
...
export default ((props: any) => (
    ...
    >
        ...
        {/* **We’re excited to learn how Sourcegraph has made your remote work experience better and would love to hear from
        you on [Twitter](https://twitter.com/srcgraph)!** **Learn more on how Sourcegraph Universal Code Search can
        improve your productivity and efficiency as a developer from our eBook:
        https://about.sourcegraph.com/resources/universal-code-search-ebook/** */}
        <WhitePaperRequestDemoForm />
    </Layout>
