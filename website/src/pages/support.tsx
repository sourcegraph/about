        ...
        <div className="text-dark">
            ...
            <div className="pricing-page mt-2">
                <ContentSection className="hero-section text-center py-5">
                    ...
                    <p>
                        See <Link to="/pricing">Pricing</Link> to learn more about these tiers.
                    </p>
                </ContentSection>
                        ...
                        <div className="col-md-4 mx-auto mb-4">
                            <div className="card">
                                ...
                                <ol className="list-group support-plan-feature list-group-flush py-3">
                                    ...
                                    <li className={liClassName}>
                                        <CheckIcon className={checkClassName} /> Email support
                                    </li>
                                    <li className={liClassName}>
                                        <CheckIcon className={checkClassName} /> Support during working hours (all North
                                        American timezones)
                                    </li>
                                    <li className={liClassName}>
                                        <CheckIcon className={checkClassName} /> 48 hour response time* to critical
                                        issues
                                    </li>
                                    <li className={`${liClassName} pricing-plan-feature__value-false`}>
                                        <CheckIcon className={nocheckClassName} />
                        ...
                        <div className="col-md-4 mx-auto mb-4">
                            <div className="card">
                                ...
                                <ol className="list-group support-plan-feature list-group-flush py-3">
                                    ...
                                    <li className={liClassName}>
                                        <CheckIcon className={checkClassName} /> 24 hour response time* to critical
                                        issues
                                    </li>
                                    <li className={liClassName}>
                                        <CheckIcon className={checkClassName} /> 99.5% uptime (managed instances only)
                                    </li>
                                    <li className={liClassName}>
                                        <CheckIcon className={checkClassName} /> Initial implementation support on
                                        architecture, deployment, configuration, and rollout
                                    </li>
                                    <li className={liClassName}>
