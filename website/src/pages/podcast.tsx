...
export const appleIcon = <svg aria-hidden="true" data-icon="podcast" viewBox="0 0 448 512" className="podcast__icon" xmlns="http://www.w3.org/2000/svg">
...
export const googleIcon = <svg className="podcast__icon" viewBox="8 8 35 35" version="1.1" id="svg4658">
...
export const spotifyIcon = <svg aria-hidden="true" data-icon="spotify" viewBox="0 0 496 512" className="podcast__icon" xmlns="http://www.w3.org/2000/svg">
...
export const rssIcon = <svg aria-hidden="true" data-icon="rss" viewBox="0 0 448 512" className="podcast__icon" xmlns="http://www.w3.org/2000/svg">
...
export const subscriptionLinks = (
    <div className="podcast__subscribe">
        ...
        <a target="_blank" href="https://www.youtube.com/playlist?list=PL6zLuuRVa1_jf5GDl61SvEOXvwvKS1IXA" className="podcast__subscribe-option">
            {youtubeIcon}&nbsp;YouTube
        </a>
...
export default class JobsPage extends React.Component<any, any> {
    ...
    public render(): JSX.Element | null {
        ...
        const publishedEpisodes = this.props.data.allMarkdownRemark.edges.filter(
