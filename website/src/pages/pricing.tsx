                ...
                <div>
                    <div className="pricing">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <p>
                                            Sourcegraph is open source and ready to use for teams of all sizes. You can
                                            get started by deploying a private Sourcegraph Core instance for free, or
                        ...
                        <div className="container pricing-section">
                            <div className="row">
                                <div className="col-xl-4 lg-12 pricing-card-col">
                        ...
                        <div className="container">
                            ...
                            <div className="table-section">
                                ...
                                <div className="row feature-table-row indent-row">
                                    <div className="col-6 feature-title">Full-text search across all repositories</div>
                                    <div className="col-2">
                                        <div className="table-check" />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row feature-table-row indent-row">
                                    <div className="col-6 feature-title">Search within diffs and commit messages</div>
                                    <div className="col-2">
                                        <div className="table-check" />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div id="integrations" className="table-section">
                                ...
                                <div className="row feature-table-row indent-row">
                                    <div className="col-6 feature-title">
                                        ...
                                        <a href="/docs/features/browser-extension/g-suite-installation" target="_blank">
                                            learn more
                                        </a>
                                        )
                                    </div>
                            ...
                            <div id="deployment" className="table-section">
                                <div className="row feature-table-row">
                                    <div className="col-6 feature-title">On-premises deployment</div>
                                    <div className="col-2">
                                        <div className="table-check" />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row feature-table-row">
                                    <div className="col-6 feature-title">Managed deployment option</div>
                                    <div className="col-2">
                                        <div className="table-blank" />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div id="support" className="table-section">
                                ...
                                <div className="row feature-table-row">
                                    <div className="col-6 feature-title">Next business day support</div>
                                    <div className="col-2">
                                        <div className="table-blank" />
                                    </div>
                                    <div className="col-2">
