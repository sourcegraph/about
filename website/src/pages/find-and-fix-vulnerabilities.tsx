    ...
    >
        <div className="container py-6">
            <div className="row">
                <div className="col-lg-6">
                    ...
                    <p>Search within and across your repositories to find and fix vulnerabilities in minutes, not weeks. Deploy fixes with confidence, knowing you've found and remediated every instance of affected code. Monitor your code long-term and ensure your customers that you're vulnerability-free.</p>
                ...
                <div className="col-lg-6 mt-4 mt-lg-0">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/13OqKPXqZXo" title="Finding and fixing vulnerabilities with Sourcegraph" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
            </div>
        </div>
        ...
        <div className="bg-gradient-onahau-mint text-center">
            <div className="container col-lg-6 py-6">
                ...
                <blockquote>
                    <p className="mb-4">&ldquo;On average, I'd say that for every automated merge request that we're able to merge we save an hour. That's a rough but conservative estimate. It shows, though, that if we are doing several thousand automated merges in a year, we're saving several employee's worth of time.&rdquo;</p>
                    <figcaption className="text-muted">—Jared Hodge, Senior Manager, Developer Experience at Indeed</figcaption>
                </blockquote>
                ...
                <Link to="/case-studies/indeed-accelerates-development-velocity" className="d-block mt-5 font-weight-bold">
        ...
        <div className="text-center">
            <div className="container col-lg-8 py-8">
                <h1 className="font-weight-bold">Ready to find, fix, and monitor vulnerabilities with confidence? Let's talk!</h1>
