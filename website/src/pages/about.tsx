                        ...
                        <div className="about__plan">
                                ...
                                <div className="container">
                                    ...
                                    <div className="row">
                                        <div className="col-md-4">
                                            ...
                                            <h2>People</h2>
                                            <p>
                                                Together we are advancing technology. We will attract, hire and retain
                                                the best teammates in the world and treat everyone in a first-class
                                                manner.
                                            </p>
                                        </div>
                                        <div className="col-md-4">
                                            ...
                                            <h2>Journey</h2>
                                            <p>
                                                The collection of moments, experiences, and memories that the team
                                                shares as we make progress: the light moments, the laughter, the team
                                        ...
                                        <div className="col-md-4">
                                            ...
                                            <h2>Progress</h2>
                                            <p>
                                                The continuous march toward achieving our mission as a team: the
                            ...
                            <div className="about__founders">
                                <div className="container">
                                    ...
                                    <Img
                                        sizes={this.props.data.Founders.childImageSharp.sizes}
                                    ...
                                    <div className="row">
                                        <div className="col">
                                            <div>
                                                ...
                                                <p>
                                                    Quinn Slack is CEO and co-founder of Sourcegraph. Prior to
                                                    Sourcegraph, Quinn co-founded Blend Labs, an enterprise technology
                                                    company with over 100 employees dedicated to improving home lending.
                                                </p>
                                                <p>
                                                    At Palantir Technologies, he created a technology platform to help
                                                    two of the top five U.S. banks recover from the housing crisis. He
                                                    was the first employee and developer at Bleacher Report after
                                        ...
                                        <div className="col">
                                            <div>
                                                ...
                                                <p>
                                                    Beyang Liu is CTO and co-founder of Sourcegraph. Prior to
                                                    Sourcegraph, Beyang was a software engineer at Palantir Technologies
                                                    where he developed new data analysis software on a small,
                                                    customer-facing team working with Fortune 500 companies.
                                                </p>
                                                <p>
                                                    Beyang studied Computer Science at Stanford, where he published
                                                    research in probabilistic graphical models and computer vision at
                                                    the Stanford AI Lab and thoroughly enjoyed his compilers course.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
