...
export const CustomerLogosSectionAnimated: React.FC<Props> = ({ showButton, className, showSection }) => {
    ...
    useEffect(() => {
        if (
            firstLogoContainerRef.current &&
            secondLogoContainerRefClone.current &&
            thirdLogoContainerRefClone.current
        ) {
            ...
            {!showButton && (
                <div className="row justify-content-center">
                    <div className="col-lg-6 text-center mt-2">
                        <a href="/contact/request-demo" className="btn btn-outline-primary">
                            Schedule a demo <ArrowRightBoxIcon className="icon-inline ml-1" />
                        </a>
                    </div>
                </div>
            )}
            <div className="customer-container-outer" ref={innerContainerRef}>
                    ...
                    <a href="/case-studies">
                        <animated.div
                            ...
                            style={{
                                left: x,
                                top: y,
                                transform: scale.interpolate(s => `scale(${s}) translate(-50%, -50%)`),
                            }}
                        >
