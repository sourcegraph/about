        ...
        <div className="tab-carousel">
            <div>
                {carouselItems.map(item => (
                    <div key={item.header} className={item === carouselHook.carouselItems.currentItem ? 'd-block' : 'd-none'}>
            ...
            <div className="d-flex justify-content-center">
                ...
                <div>
                    {carouselItems.map(item => (
                        <CircleSmallIcon color={item === carouselHook.carouselItems.currentItem ? '#000' : '#D0D0D0'} key={item.header} />
                    ))}
                </div>
                <ArrowRightIcon
                    className="ml-4"
