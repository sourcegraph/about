...
export const QuoteCarousel: FunctionComponent<QuoteCarouselProps> = ({ items, autoAdvance }) => {
    ...
    return (
        <div className="d-flex flex-lg-row flex-column justify-content-center text-center height-xl-450 height-lg-450 height-md-450 height-sm-550 position-relative">
