            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-6 self-hosted-section__local">
                        <h2 className="self-hosted-section__search-headings">Install Sourcegraph locally:</h2>
                        <div className="self-hosted-section__installtext border boxshadow" onClick={() => copyText()}>
                            <span id="installText">
                                docker run <br />
