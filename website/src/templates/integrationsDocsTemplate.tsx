...
import IntegrationsDocs from '../components/IntegrationsDocs'
import { ServerVersionNumber } from '../components/ServerVersionNumber'
import { eventLogger } from '../EventLogger'

export default class IntegrationsDocsTemplate extends React.Component<any, any> {
    ...
    public render(): JSX.Element | null {
        ...
        return (
            <IntegrationsDocs location={this.props.location}>
...
export const pageQuery = graphql`
    query integrationsDocsTemplate($fileSlug: String) {
