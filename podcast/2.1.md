...
<!-- START SUMMARY -->
We're kicking off a new season of the Sourcegraph podcast talking about how engineers start off when diving into new code: Onboarding is the topic of discussion for three-part series with three different engineering leaders. 
