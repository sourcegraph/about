...
And they were also migrating from Ruby to GBM, to not Scala but Java. And I was like, "Yeah, I have expertise, and I want to help do it the right way, without spending too much time on the mistakes that everyone does." And at Airbnb, when I joined, there were less than 300 engineers. It's still a lot, but compared to Twitter where I think it was almost 2,000 when I left.
...
In theory, it shouldn't fail because it's all containerized and blah, blah, blah. But if you're changing out the underlying thing, at the end of the day, it's the abstraction battery's not perfect. Right.
...
And then, two, it's just the versatility of compute environments that you're able to support, because of this model. Is that a good encapsulation of the core value property?
