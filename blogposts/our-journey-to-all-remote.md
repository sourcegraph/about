...
author: Nick Snyder
publishDate: 2020-03-3-T10:00-07:00
tags: [
  blog, remote
]
...
- Conclusions
    - We don't need to continue having coordinated distributed day to achieve productivity. If individual teammates want to periodically work from a different location to be productive, they should do so.
...
Near the end of 2019 we decided to become all-remote and get rid of our SF office entirely. As our team grew, we didn't want to create a growing SF office subculture at the company. We wanted to treat everyone equally and didn’t want our distributed teammates to feel second class. We knew that continuing to have an office as the team grew would be an increasing risk to our remote-first culture, so we decided to go all-in.

Once this decision was made, there were a few logistical issues that we needed to figure out:

- Update our perks and benefits so they make sense for an all-remote team (e.g., we removed our lunch benefit for SF teammates and added a benefit to pay for internet at home).
- Give everyone a budget to set up their home office or work from a co-working space (so nobody would become less productive as was discovered during distributed days).
- Create explicit travel budgets so teammates can meetup regularly (we supported travel before this transition but the budgets weren't well defined).

## Tradeoffs

We love all-remote, but it doesn't work for everyone (just like working on an open-office plan doesn't work for everyone). Working remotely gives you extra freedom and flexibility, but also requires extra discipline and personal responsibility. Certain things that happen organically in an office environment (e.g., informal conversations at lunch), need to be explicitly planned (e.g., by scheduling team "watercooler" meetings with no agenda, or scheduling 1-1 between random teammates using a tool like donut.com).
...
If you have any questions about all-remote teams, join us during our next office hours and we will be happy to answer them.