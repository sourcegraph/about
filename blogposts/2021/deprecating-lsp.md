...
We believe Language Servers have been unused (with Sourcegraph) ihn the wild for some time. Based on our analytics, enterprise usage was very low. We've helped the remaining one or two users migrate to our LSIF-based precsie code intelligence.
