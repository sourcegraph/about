...
1. **Write down on paper what you know or think you know about your system**<br>
...
1. Did I really come to a talk about bug discovery where the solution is "go talk to people and write stuff down"?
...
- The system we talked about had resources and users belonging to accounts, the generated diagram doesn't reflect that.
    - Next Steps Taken in Alloy GUI:
        ...
        1. Uses lone to set parent resource (less than or equal to one) attribute on resource
        1. Runs execute: Alloy generates new diagram:
