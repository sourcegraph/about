...
The rewrite has unlocked a large number of performance improvement opportunities, the results of which are described in [A technical deep-dive into how we made code navigation twice as fast](/blog/making-code-nav-twice-as-fast).
