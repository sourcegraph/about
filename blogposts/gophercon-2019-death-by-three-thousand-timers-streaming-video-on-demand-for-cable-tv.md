...
![Several streams multiplexed on one cpu](/gophercon-2019/death-by-3000-timers-Several streams multiplexed on one cpu.png)

into this?

![what if we could do this?](/gophercon-2019/death-by-3000-timers-What if we could do this.png)
...
![Go 1.9 Naive](/gophercon-2019/death-by-3000-timers-09 go-1.9-naive.png)
...
![Go 1.11 Naive](/gophercon-2019/death-by-3000-timers-10 go-1.11-naive.png)
...
![Go 1.11 Sync/Wake](/gophercon-2019/death-by-3000-timers-11 go-1.11-sync-wake.png)
...
![Go 1.11 Multiplexed](/gophercon-2019/death-by-3000-timers-12 go-1.11-multiplexed.png)
...
![New timers](/gophercon-2019/death-by-3000-timers-13 new timers.png)
...
![New timers multiplexed](/gophercon-2019/death-by-3000-timers-14 new timers multiplexed.png)
