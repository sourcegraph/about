...
import { ContentSection, CustomerLogos, Heading, HubSpotForm, Layout } from '../components'
...
const ForresterTotalEconomicImpact: FunctionComponent = () => (
    ...
    >
        ...
        <div className="mt-16 flex flex-col items-center justify-center gap-6 px-sm md:flex-row md:items-start">
            <div className="flex max-w-[411px] flex-1 flex-col items-center gap-6">
                <MinusCircle className="mx-0 rounded bg-violet-200 p-2 text-violet-400" size={48} />
                <Heading size="h4" className="text-center text-white">
                    Eliminating other search tools and solutions
                </Heading>
            </div>
            <div className="flex max-w-[411px] flex-1 flex-col items-center gap-6">
                <CodeTags className="mx-0 rounded bg-violet-200 p-2 text-violet-400" size={48} />
                <Heading size="h4" className="text-center text-white">
                    Reduced developer labor cost for typical search and understanding activities
                </Heading>
            </div>
            <div className="flex max-w-[411px] flex-1 flex-col items-center gap-6">
                <CurrencyDollar className="mx-0 rounded bg-violet-200 p-2 text-violet-400" size={48} />
                <Heading size="h4" className="text-center text-white">
