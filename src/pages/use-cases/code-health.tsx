...
const threeUpTextItems = [
    {
        icon: <MagnifyIcon className="mb-4 bg-violet-mist text-vivid-violet rounded p-2" size={48} />,
    ...
    {
        icon: <WrenchOutlineIcon className="mb-4 bg-violet-mist text-vivid-violet rounded p-2" size={48} />,
    ...
    {
        icon: <ClipBoardPulseOutlineIcon className="mb-4 bg-violet-mist text-vivid-violet rounded p-2" size={48} />,
