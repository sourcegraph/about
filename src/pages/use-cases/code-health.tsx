...
const threeUpTextItems = [
    {
        icon: <Icon name="SearchSharp" variant="boxed" className="mb-4" />,
    ...
    {
        icon: <Icon name="BuildSharp" variant="boxed" className="mb-4" />,
    ...
    {
        icon: <Icon name="MonitorHeartOutlined" variant="boxed" className="mb-4" />,
