...
const threeUpTextItems = [
    {
        icon: <XmlIcon className="mb-4 bg-violet-mist text-vivid-violet rounded p-2" size={48} />,
    ...
    {
        icon: <FolderUploadOutlineIcon className="mb-4 bg-violet-mist text-vivid-violet rounded p-2" size={48} />,
        subtitle: (
    ...
    {
        icon: <AccountGroupOutlineIcon className="mb-4 bg-violet-mist text-vivid-violet rounded p-2" size={48} />,
        subtitle: (
