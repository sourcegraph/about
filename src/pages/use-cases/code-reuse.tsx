...
const threeUpTextItems = [
    {
        icon: <Icon name="CodeSharp" variant="boxed" className="mb-4" />,
    ...
    {
        icon: <Icon name="DriveFolderUploadSharp" variant="boxed" className="mb-4" />,
        subtitle: (
    ...
    {
        icon: <Icon name="GroupSharp" variant="boxed" className="mb-4" />,
        subtitle: (
