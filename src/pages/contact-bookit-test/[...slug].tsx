...
import { slugs, slugData, type ContactBookKitTestPageProps } from './data'

/**
 * This is a contact page slug template. The data used to generate these pages
 * can be found in data.ts.
 */
const ContactBookKitTestPage: NextPage<ContactBookKitTestPageProps> = ({
    title,
    description,
    masterFormName,
    formId,
...
export default ContactBookKitTestPage
