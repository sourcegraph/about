        ...
        <NewCaseStudyLayout customer="HashiCorp">
            ...
            <ContentSection background="white" slimWidth={true}>
                <div className="tw-mx-auto tw-pt-5xl">
                    ...
                    <h3 className="tw-mt-16 tw-mb-6">Web team accelerates developer velocity by an estimated 4X</h3>
                    <p>
                    ...
                    <h3 className="tw-mb-6">Visibility into code usage reduces technical debt</h3>
                    <p>
                    ...
                    <h3 className="tw-mt-16 tw-mb-6">Creating a new component library</h3>
                    <p>
