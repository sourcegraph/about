        ...
        <NewCaseStudyLayout customer="Codecov">
            ...
            <ContentSection color="white" className="pt-lg-8 py-7 max-w-700 col-xl-5">
                ...
                <p>
                    ...
                    library, had a security vulnerability so severe it scored a 10/10 on the CVSS scale. The use of the
                    library was, as the FTC put it, "
                    <a
                        target="_blank"
                        rel="noreferrer"
                ...
                <p>
                    ...
                    codebases and how fast they could patch it. For many companies, it was a stressful, high-pressure
                ...
                <p>
                    Not Codecov. With Sourcegraph, said Mitchell, Codecov was able to “get a quick reconnaissance and
                    understand our possible exposure by doing some simple searches.”
                </p>
                <p>
                ...
                <p>
                    “Confidence is everything,” said Holland. “It's extremely important, the 100% confidence that you
                    can go out in good faith to your customers and report the absence of a vulnerability.” Other
                    companies, according to Holland, instead had to temper expectations and some even had to walk back
                    assurances. “It deeply affects the trust that you can provide to customers,” Holland said.
                </p>
                <p>
                    Log4j was a particularly severe instance of a common pattern: companies adopt an open source code
                    component, often packaged with other components, not realizing it contains a vulnerability. These
                    kinds of vulnerabilities are on the rise but with Sourcegraph, Codecov is prepared. The next time a
                    vulnerability emerges, Codecov can find all instances of it-if any-in their codebase with just a
                    search.
                </p>
                <p>
                    “If Log4j version 7 comes out and all of the sudden it affects us and we've got a can of worms on
                    our hands, what do we do? Start searching with Sourcegraph,” said Jeff. “And pretty quickly, we can
                    figure out if we're vulnerable and patch. And hopefully we avoid an incident versus floundering
                ...
                <p>
                    Code reviews are now comprehensive, which is helpful over and above security reviews. “Sourcegraph
                    makes code reviews a lot more thorough,” Mitchell said. “And you have faith that you don't have to
                    go back and confirm, double check, and triple check.”
                </p>
                <p>
                    By the time he's done reviewing code, Mitchell is confident: “I have more assurance in the
                    effectiveness of my own code reviews. I have more faith that it is an accurate code review and that
                ...
                <p>
                    Sourcegraph helps developers help themselves and each other. “I want developers to only have to help
                    each other when necessary,” said Jerrod. Sourcegraph searches have helped Codecov developers answer
                    questions ahead of time, before they have to ask for help and wait, often across time zones, for a
                    response.
                </p>
                <p>
                    Efficiency is only half the benefit. According to Jerrod, “We increased the interpersonal trust and
                    we increased the interpersonal dynamics in the company, making people feel more welcomed.”
                </p>
                <p>
                    Asking for help, of course, isn't a practice exclusive to early career developers. “Sourcegraph will
                    not only help with their onboarding,” said Mitchell. “It'll help post-onboarding, increasing the
                    developers' usability across the repositories we have.”
                </p>
            </ContentSection>
