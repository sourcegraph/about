...
const threeUpTextItems = [
    {
        ...
        description: 'Codecov reviewed their entire codebase and confirmed that they weren\'t exposed to the Log4j vulnerability.',
    },
    {
        subtitle: <h3 className="pb-3 mx-md-auto display-3 font-weight-bold text-blurple">12x faster</h3>,
        description: 'CodeCov was able to resolve Log4j 12x faster than with a native code search tool and report absolute confidence in that resolution to their customers.',
    },
    {
        subtitle: <h3 className="pb-3 mx-md-auto display-3 font-weight-bold text-blurple">100% confidence</h3>,
        description: 'The security team at Codecov is able to complete code reviews independently and with complete confidence that their work is correct.',
    },
]
    ...
    >
        <NewCaseStudyLayout customer="Codecov">
            ...
            <ContentSection color="white" className="pt-lg-8 py-7 max-w-700 col-xl-5">
                ...
                <p>
                    Key to their efforts? Sourcegraph. According to Jeff, “Sourcegraph allows us to be more efficient with our time, whether it's code review, quickly answering security-related questions from clients quite quickly, or searching for things in the code more easily than we could through other tools.”
                </p>
                <h3 className="mt-6 mb-4 display-4 font-weight-normal max-w-600">
                    Codecov reduced time-to-resolution 100% when facing Log4j
                </h3>
                <p>
                    In December of 2021, researchers discovered that Log4j, an otherwise nondescript open source logging library, had a security vulnerability so severe it scored a 10/10 on the CVSS scale. The use of the library was, as the FTC put it, "
                    <a target="_blank" rel="noreferrer" href="https://www.ftc.gov/policy/advocacy-research/tech-at-ftc/2022/01/ftc-warns-companies-remediate-log4j-security-vulnerability">
                        ubiquitous
                    </a>
                    ."
                </p>
            ...
            <ContentSection color="white" className="py-7 max-w-700 col-xl-5">
                ...
                <p>
                    The Codecov team got started with Sourcegraph quickly and now, they're excited to expand. Already, support engineers are using Sourcegraph to quickly answer customer questions and the team is looking to share Sourcegraph with new engineers to help them become code search masters too.
                </p>
                <p>
