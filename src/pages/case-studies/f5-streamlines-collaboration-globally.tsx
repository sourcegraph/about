        ...
        >
            <ContentSection color="white" className="col-md-6 pb-5">
                <div className="container">
                    ...
                    <InContentBlockquote quote="Before Sourcegraph, each of our teams was siloed. Developers could understand their own codebase, but it was difficult for them to see and understand other team members' code." />
                    <p>
                    ...
                    <InContentBlockquote quote="If I want to have a dialogue with a developer on a different team, it's as simple as pulling up Sourcegraph and walking through the code." />
                    ...
                    <InContentBlockquote quote="When I work with remote teams and I want to give them an example of a piece or pattern of code, I use Sourcegraph to find the code snippets I need and simply send them the links. This is especially helpful because I can see who wrote the code and find out their thinking behind it." />
                    <InContentBlockquote quote="We are developing software faster than ever, with aggressive schedules, and across boundaries. Things that used to be worked out in a closed room now need to be done while teams are spread out across the globe. Sourcegraph is essential in this environment, and I can't imagine being proficient at my job without it." />
                    <p>
