        ...
        >
            <ContentSection color="white" className="col-md-6 pb-5">
                <div className="container">
                    ...
                    <Blockquote quote="Before Sourcegraph, each of our teams was siloed. Developers could understand their own codebase, but it was difficult for them to see and understand other team members' code." center={false} />
                    <p>
                    ...
                    <Blockquote quote="If I want to have a dialogue with a developer on a different team, it's as simple as pulling up Sourcegraph and walking through the code." center={false} />
