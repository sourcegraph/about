        ...
        >
            <ContentSection color="white" className="col-md-6">
                <div className="container">
                    ...
                    <Blockquote quote="I was asked to provide the max size of our database connection pulls from our clients. To get this number I used my IDE to search through a repository I had cloned locally before. I didn't notice that the repository was outdated and the data I was providing was already a few days old. It consisted of only half of the actual amount which led to a wrong estimation, overprovisioning of a fleet, and messed up database connections. An expensive mistake." center={false} />
                    <Blockquote quote="Now that we are using Sourcegraph, we don't need to worry about data being out of date." center={false} />
                    <Blockquote
