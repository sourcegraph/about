        ...
        >
            <ContentSection color="white" className="col-md-6">
                <div className="container">
                    ...
                    <Blockquote quote="Ensuring that changes to legacy systems didn't affect production stability was taking too long." center={false} />
                    ...
                    <Blockquote quote="In pull requests, team members include links to Sourcegraph code search to prove all references to a deprecated system have been removed, giving the reviewer confidence that the code is safe to merge." center={false} />
