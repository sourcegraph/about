            ...
            hero={
                <TwoColumnContentSection
                    ...
                    subContent={
                        <>
                            <p>
                                We believe this recognition validates our philosophy to build a tool that helps make
                                solving the hardest problems for enterprises like code modernization or fixing security
