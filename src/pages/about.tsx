...
const About: FunctionComponent = () => (
    ...
    >
        <div className="bg-white content-page text-dark">
            ...
            <ContentSection>
                <h2>Investors</h2>
                <div className="mx-5 row align-items-center">
                    {INVESTORS.map(investor => (
                        <div key={investor.image} className="mx-auto my-5 col-md-4">
                            <img src={investor.image} alt={investor.name} className="px-2 py-0 mx-0 my-1 w-100" />
                        </div>
                    ))}
                </div>
            </ContentSection>
