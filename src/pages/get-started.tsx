    ...
    <div className="mt-8 md:mt-0">
        ...
        <div className="mt-6 rounded-2xl bg-gray-100 px-8 py-10">
            ...
            <div className="mx-0.5 flex flex-col px-4">
                <ol className="flex flex-col m-0 text-left gap-2">
                    <li className="max-w-[356px] text-base leading-7">
                        <div className="self-start text-base leading-7">
                            Install via{' '}
                            <Link
                                href="https://brew.sh"
                                title="Homebrew"
                        ...
                        <CodeSnippet
                            ...
                            code="brew install sourcegraph/app/sourcegraph"
                            className="-ml-2.5 mb-0"
                        />
                    </li>
                    <li className="text-base leading-7">
                        Run <code className="rounded-md bg-gray-200 p-1 text-xs text-gray-700">sourcegraph</code> in
        ...
        <p className="mt-6 mb-0 text-base text-gray-500">
            ...
            <Link href="/terms/privacy" title="Privacy policy" className="text-gray-500 underline">
                privacy policy
            </Link>{' '}
            and{' '}
