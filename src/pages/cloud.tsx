...
const Cloud: FunctionComponent = () => (
    <Layout
        ...
        hero={
            <Hero
                ...
                variant="radialSpace"
                className='md:!pt-[152px] md:h-[805px] lg:!mb-0'
                ...
                centerContent={true}
                cta={
                  <div className='mx-auto flex w-full flex-col items-center gap-6 md:gap-4 sm:flex sm:flex-row justify-center'>
                    <Link 
                      className='btn whitespace-nowrap btn-inverted-primary min-w-[135px]'
                    ...
                    <Link 
                      className='btn inline-flex items-center whitespace-nowrap btn-outline-white min-w-[135px]'
                      href="/get-started"
                      title='Get started'
    ...
    >
        <ContentSection background="white" parentClassName='md:!pt-28 md:!pb-5xl lg:!pt-5xl'>
            <div className="flex-row lg:flex">
                <h2 className="mb-10 md:min-w-[400px] max-w-3xl lg:basis-1/3 md:pr-4 md:mr-6">
                ...
                <div className="max-w-full basis-2/3">
                    <TwoColumnSection
                        ...
                        className='md:!gap-x-6 !gap-y-8'
                        leftColumn={
                            <div>
                                <div className="mb-6 md:mb-5 flex max-h-[48px] max-w-[48px] items-center rounded bg-violet-100 p-2.5">
                        ...
                        leftColumn={
                            <div>
                                ...
                                <p className="m-0">
                                    ...
                                    <Link href='/batch-changes' className='text-black underline'>Batch Changes</Link>.
                                </p>
                            </div>
                        }
                        rightColumn={
                            <div>
                                ...
                                <p className="m-0">
                                    ...
                                    <Link href='/code-insights' className='text-black underline'>Code Insights</Link>.
                                </p>
                            </div>
                        }
                    />
        ...
        <ContentSection background="white" className='md:py-4' parentClassName='!py-0'>
            <TwoColumnSection
            ...
            <TwoColumnSection
                ...
                leftColumn={
                    <div className="flex justify-center">
                        <span className="mt-[30px] md:mt-[46px] h-px w-10 md:w-20 bg-gray-300" />
                        <div className="mx-[33px] text-center">
                            <img src="/security/ccpa.svg" alt="CCPA badge" />
                            <p className="mt-xxs mb-0 text-gray-400 font-semibold">CCPA</p>
                        </div>
                        <div className="mr-[36.5px] text-center">
                            <img src="/security/gdpr.svg" alt="GDPR badge" />
                            <p className="mt-xxs mb-0 text-gray-400 font-semibold">GDPR</p>
                        </div>
                        <div className="mr-[36.5px] text-center">
                            <img src="/security/soc2.svg" alt="SOC2 Type 2 badge" />
                            <p className="mt-xxs mb-0 text-gray-400 font-semibold">SOC2 TYPE 2</p>
                        </div>
                        <span className="mt-[30px] md:mt-[46px] h-px w-10 md:w-20 bg-gray-300" />
                    </div>
                }
                    ...
                    <>
                        ...
                        <ul className="ml-md mt-sm">
                            ...
                            <li> 
                                ...
                                See our <a href='https://security.sourcegraph.com/' target="_blank" rel="noreferrer" className='text-black underline'>security portal</a> for more information.
                            </li>
                        </ul>
                    </>
                }
        ...
        <ContentSection background="white" parentClassName="!p-0 !pt-[5px] md:!pt-4 md:!pb-28">
            <div className="sg-bg-code-search-cta mx-auto flex w-full max-w-[941px] flex-col md:items-center justify-between gap-x-8 rounded-0 bg-no-repeat py-16 px-6 shadow-cta md:rounded-2xl md:bg-[lightgray] md:bg-[url('/code-search/cta-background.png')] md:bg-cover md:bg-right md:py-24 md:px-20 lg:flex-row">
                <div className="max-w-[516px] pb-8 md:pb-0">
                    <Heading size="h2" className="mb-6 !text-4xl text-white">
                        Try Sourcegraph on your code
                    </Heading>
                    <p className="max-w-2xl mb-0 text-lg text-gray-200">
                ...
                <div className="flex w-full flex-col items-start justify-start gap-4 md:w-fit md:flex-row md:items-center md:justify-center">
                    <Link
                      className='btn min-w-fit text-center px-6 lg:px-4 btn-inverted-primary text-violet-500'
                      href="/demo"
                    >
