...
export const CaseStudyJumbotron: FunctionComponent<Props> = ({ customer, logo, className = '', color = 'dark', children }) => (
    <div className={`jumbotron ${COLORS[color]} ${className}`}>
        <div className="container mx-auto pt-8 sm:pl-0">
            <BackButton href="/case-studies" text="Customer stories" light={color === 'dark'} />
        </div>
