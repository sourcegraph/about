export const NoItemsFound = (): any => (
  <div className="flex flex-col items-center gap-[16px] p-[64px_0_112px_0]">
    ...
    <h2 className='text-[#343A4D] text-center font-sans text-2xl font-semibold leading-[130%] tracking-[-0.25px]'>
      There are no items that match your search criteria.
    </h2>
    <p className='text-[#343A4D] text-center font-sans text-lg font-normal leading-[150%] tracking-[-0.25px]'>
