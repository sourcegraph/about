...
export function PostDetailsInfo({ version, avatar, username, keywords, date }: PostInfoProps): any {
  return (
    <div className="flex items-center space-x-6 my-4 mb-8 text-gray-700 text-sm font-sans">
      <span  className="flex items-center space-x-2 text-gray-700 text-sm font-sans" >
        ...
        />
        <span className="text-gray-700 font-sans text-sm font-normal leading-[150%] tracking-[0px]">{username}</span>
      </span>
      ...
      <span className="flex items-center text-gray-500 space-x-2">
        <span className="flex items-center space-x-1">
          ...
          {keywords.map((keyword, index) => (
            <span key={index} className="text-gray-700 font-sans text-sm font-normal leading-[150%] tracking-[0px]">
              {keyword}, 
            </span>
          ))}
