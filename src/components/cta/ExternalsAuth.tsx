...
export interface AuthProvider {
  serviceType: 'github' | 'gitlab' | 'google' | 'VS Code' | 'JetBrains';
}
...
const GitlabColorIcon: FunctionComponent<
...
const GoogleColorIcon: FunctionComponent<
  PropsWithChildren<{ className?: string }>
> = ({ className }) => (
  <svg
    className={className}
...
const JetBrainsColorIcon: FunctionComponent<
  PropsWithChildren<{ className?: string }>
> = ({ className }) => (
  <svg
    className={className}
  ...
  >
    <path
      d='M0.416992 0.852783H12.036V12.4718H0.416992V0.852783Z'
      fill='black'
    />
    ...
    />
    <path
      d='M5.2058 2.74864H4.66357V2.30518H6.25345V2.74476H5.70929V4.11968H5.2058V2.74864Z'
      fill='white'
    />
    <path
...
export const ExternalsAuth: FunctionComponent<ExternalsAuthProps> = ({
  ...
  const handleOnClick = (): void => {
    ...
    if (authProvider === 'VS Code' || authProvider === 'JetBrains') {
