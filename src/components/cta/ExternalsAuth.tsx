            ...
            return (
                <Link
                    ...
                    className={classNames(
                        'hover:sg-bg-hover-external-auth-button flex items-center px-4 py-2 font-normal hover:text-black md:h-12 md:px-6 md:text-base',
                        dark
        ...
        case 'google':
            return (
                <Link
                    ...
                    className={classNames(
                        'hover:sg-bg-hover-external-auth-button flex items-center px-4 py-2 font-normal font-normal hover:text-black md:h-12 md:px-6 md:text-base',
                        dark
                            ? 'sg-gitlab-bg-color hover:btn-primary text-white '
                            : 'btn-inverted-primary rounded-[3px] border border-gray-400 text-black',
                        className
                    ...
                    id="googleButton"
                >
                    <GoogleColorIcon className="mr-2 h-6 w-6" />
                    {label}
                </Link>
            )
        default:
