...
export const CodePointer: FunctionComponent<CodePointerProps> = ({ active = false }) => (
    <div
        className={classNames('absolute right-0 z-50 flex h-full w-[110px] items-center  pb-8', {
            'opacity-0': !active,
        })}
    >
        ...
        <div className="bg-grad absolute right-0 bottom-0 h-full w-[1px] flex-1 bg-gradient-to-b from-blue-300 via-violet-400 to-vermillion-300" />
    </div>
)
