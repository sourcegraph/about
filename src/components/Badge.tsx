...
export const Badge: FunctionComponent<Badge> = ({
    ...
    const colors = {
        'light-gray': {
            ...
            hover: 'md:hover:bg-gray-300 md:hover:text-gray-600',
        },
        white: {
            base: '',
            unchecked: 'bg-white',
            checked: 'bg-gray-500 text-white',
            hover: 'md:hover:bg-gray-200 md:hover:text-gray-500',
        },
        'white-outlined': {
            base: 'border border-solid border-gray-500',
            unchecked: 'bg-white text-gray-500',
            checked: 'bg-gray-500 text-white',
            hover: 'md:hover:bg-gray-500 md:hover:text-white',
        },
        'dark-gray': {
            base: '',
            unchecked: 'bg-gray-500 text-white',
            checked: 'bg-gray-700 text-white',
            hover: 'md:hover:bg-gray-700 md:hover:text-white',
        },
        blue: {
            base: 'bg-blue-100 text-blue-400',
            unchecked: '',
            checked: '',
            hover: 'md:hover:bg-blue-400 md:hover:text-blue-100',
        },
        'dark-blue': {
            base: 'bg-blue-400 text-blue-100',
            unchecked: '',
            checked: '',
            hover: 'md:hover:bg-blue-100 md:hover:text-blue-400',
        },
        blurple: {
            base: 'bg-blurple-100 text-blurple-500',
            unchecked: '',
            checked: '',
            hover: 'md:hover:bg-blurple-500 md:hover:text-blurple-100',
        },
        violet: {
            base: 'bg-violet-100 text-violet-600',
            unchecked: '',
            checked: '',
            hover: 'md:hover:bg-violet-600 md:hover:text-violet-100',
        },
        'violet-outlined': {
        ...
        cerise: {
            ...
            unchecked: '',
            checked: '',
            hover: 'md:hover:bg-cerise-600 md:hover:text-cerise-100',
        },
        vermillion: {
            base: 'bg-vermillion-100 text-vermillion-500',
            unchecked: '',
            checked: '',
            hover: 'md:hover:bg-vermillion-500 md:hover:text-vermillion-100',
        },
        green: {
            base: 'bg-green-100 text-green-500',
            unchecked: '',
            checked: '',
            hover: 'md:hover:bg-green-500 md:hover:text-green-100',
        },
        lemon: {
            base: 'bg-lemon-100 text-vermillion-500',
            unchecked: '',
            checked: '',
            hover: 'md:hover:bg-lemon-500 md:hover:text-lemon-100',
        },
    }
