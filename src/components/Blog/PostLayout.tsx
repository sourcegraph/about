...
import { Alert, BlockquoteWithBorder, EmbeddedHubSpot, Video, YouTube } from '@components'
import { PostComponentProps } from '@interfaces/posts'
import { formatDate } from '@util'

export type Components = import('mdx/types').MDXComponents
const components = { Alert, BlockquoteWithBorder, EmbeddedHubSpot, Video, YouTube }
