...
const enterpriseDarkDevPlatforms = [
    ...
    { src: '/enterprise/logo-tiles/neovim-dark.svg', alt: 'Neovim' },
...
const enterpriseLightDevPlatforms = [
    ...
    { src: '/enterprise/logo-tiles/neovim-light.svg', alt: 'Neovim' },
    { src: '/enterprise/logo-tiles/go-light.svg', alt: 'Golang' },
...
export const DevPlatformsSection: FunctionComponent<DevPlatformsSectionProps> = ({
    ...
    return (
        <div className="flex w-auto justify-center gap-6 md:gap-6">
